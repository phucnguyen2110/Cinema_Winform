...
namespace GUI.frmAdminUserControls.DataUserControl
{
    public partial class FormatMovieUC : UserControl
    {
        ...
        void InsertFormat(string id, string idMovie, string idScreen)
        {
            ...
            {
                MessageBox.Show("Thêm định dạng thất bại", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        void UpdateFormat(string id, string idMovie, string idScreen)
        {
            ...
            {
                MessageBox.Show("Sửa định dạng thất bại", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        void DeleteFormat(string id)
        {
            ...
            {
                MessageBox.Show("Xóa định dạng thất bại", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
