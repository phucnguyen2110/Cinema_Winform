...
namespace GUI.frmAdminUserControls.DataUserControl
{
    public partial class MovieUC : UserControl
    {
        ...
        void InsertMovie(string id, string name, string desc, float length, DateTime startDate, DateTime endDate, string productor, string director, int year, byte[] image)
        {
            ...
            {
                MessageBox.Show("Thêm phim thất bại", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btnAddMovie_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Mời bạn thêm hình ảnh cho phim trước", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
