...
namespace GUI.frmAdminUserControls.DataUserControl
{
    public partial class ScreenTypeUC : UserControl
    {
        ...
        void InsertScreenType(string id, string name)
        {
            ...
            {
                MessageBox.Show("Thêm loại màn hình thành công", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            { 
                MessageBox.Show("Thêm loại màn hình thất bại", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        void UpdateScreenType(string id, string name)
        {
            ...
            {
                MessageBox.Show("Sửa loại màn hình thành công", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
                MessageBox.Show("Sửa loại màn hình thất bại", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        void DeleteScreenType(string id)
        {
            ...
            {
                MessageBox.Show("Xóa loại màn hình thành công", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
                MessageBox.Show("Xóa loại màn hình thất bại", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
